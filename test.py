...
class Calibration:
    ...
    def estimate_reprojection_error(self, K, kC, M_pts, m_pts, Extrinsics, is_cv2=False):
        return self.math_utils.estimateReprojectionError(K, kC, (M_pts, m_pts, Extrinsics), is_cv2)
...
if __name__ == '__main__':
    ...
    calibration = Calibration(args.DataPath, args.SavePath)
    calibration.main()
